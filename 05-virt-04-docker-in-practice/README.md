...
https://github.com/romanishkov/shvirtd-example-python

![](img/4-1.png)

```bash
cd /opt
sudo mkdir shvirtd-example-python
sudo chown odmin:odmin shvirtd-example-python/
git clone https://github.com/romanishkov/shvirtd-example-python.git
cd shvirtd-example-python/
echo "MYSQL_ROOT_PASSWORD=somerootpass" >> .env
echo "MYSQL_PASSWORD=mypass" >> .env
docker compose up -d
```
