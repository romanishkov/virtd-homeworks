...
```Если речь идёт о паравиртализации, то основная проблема - использовать аппаратные инструкции виртуализации и иметь низкоуровневый доступ к "железу" может только один гипервизор.
